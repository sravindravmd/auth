...
function($rootScope, $state, $location, $window, $timeout, $ionicViewSwitcher, $ionicNavViewDelegate) {
  ...
  return {
     ...
     * @param {number=} backCount Optional negative integer setting how many templates to go
     * back. By default it'll go back one view by using the value `-1`. To go back two
     * templates you would use `-2`. If the number goes farther back than the number of templates
